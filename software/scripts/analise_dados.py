...
Responsabilidades (arquitetura de microsserviços):
  1. INGESTÃO  : baixa clima real (Open-Meteo/ERA5 → CSV em software/dados);
...
DADOS: Final[Path] = REPO / "software" / "dados"
DADOS.mkdir(parents=True, exist_ok=True)
CSV_CLIMA: Final[Path] = DADOS / "clima_semiarido_petrolina.csv"
OUT_CSV: Final[Path] = DADOS / "projetoes_tupan.csv"
OUT_JSON: Final[Path] = DADOS / "metricas_ml.json"
OUT_FIG: Final[Path] = DADOS / "grafico_ml_vs_fisica.png"

# ---------------------------------------------------------------------------
# NÚCLEO NATIVO (pybind) com FALLBACK puro-Python (microsserviço tolerante).
# ---------------------------------------------------------------------------
import sys as _sys
DIST: Final[Path] = REPO / "software" / "scripts" / "dist" / "bin"
